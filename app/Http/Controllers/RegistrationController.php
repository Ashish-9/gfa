    ...
    public function store(Request $request)
    {
        if($request->isMethod('post')){
            ...
            try{
                ...
                $register->best_in_healthy = $request->best_in_healthy;
                $register->best_micro = $request->best_micro;
                $register->best_gigs = $request->best_gigs;
                $register->best_family = $request->best_family;
                $register->best_qsr = $request->best_qsr;
                $register->best_biryani = $request->best_biryani;
                $register->best_barbeque = $request->best_barbeque;
                $register->best_local_chain = $request->best_local_chain;
                $register->best_brand_chain = $request->best_brand_chain;
                $register->best_inno = $request->best_inno;
                $register->best_home_baker = $request->best_home_baker;
                $register->best_home_chef = $request->best_home_chef;
                $register->best_chef = $request->best_chef;
                $register->best_money = $request->best_money;
