...
class CreateRegistrationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('registrations', function (Blueprint $table) {
            ...
            $table->text('best_in_healthy')->nullable();
            $table->text('best_micro')->nullable();
            $table->text('best_gigs')->nullable();
            $table->text('best_family')->nullable();
            $table->text('best_qsr')->nullable();
            $table->text('best_biryani')->nullable();
            $table->text('best_barbeque')->nullable();
            $table->text('best_local_chain')->nullable();
            $table->text('best_brand_chain')->nullable();
            $table->text('best_inno')->nullable();
            $table->text('best_home_baker')->nullable();
            $table->text('best_home_chef')->nullable();
            $table->text('best_chef')->nullable();
            $table->text('best_money')->nullable();
